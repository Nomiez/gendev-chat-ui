...
def accept_quote(conversation_id: int, user_id: int) -> None:
    ...
    conversation_repository.update_state_of_conversation(conversation_id, State.ACCEPTED)
...
def reject_quote(conversation_id: int, user_id: int) -> None:
    ...
    conversation_repository.update_state_of_conversation(conversation_id, State.REJECTED)
